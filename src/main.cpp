#include <iostream>
#include "../include/src/versionen/main_v1_unsicher.h"
#include "../include/src/versionen/main_v2_hashing_MD5.h"
#include "../include/src/versionen/main_v3_hashing_SHA256.h"
#include "../include/src/versionen/main_v4_salted_hashing.h"
#include "../include/src/versionen/main_v5_peppered_hashing.h"
#include "../include/src/versionen/main_v6_2fa.h"
...
public:
	...
	void menueAnzeige() {
		...
		std::cout << "1. Versionen\n"
				  << "2. tools\n"
				  << "3. Hash Generator\n"
				  << "4. Staerke des Passwortes testen (Entropie)\n"
				  << "5. beenden\n\n";
		std::cout << "******************************************" << std::endl << std::endl;
